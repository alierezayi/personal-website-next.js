  ...
  return (
    <div className="z-[999] fixed top-5 lg:top-[36px] left-1/2 -translate-x-1/2 px-4 h-[52px] flex items-center">
      <motion.div
        ...
        className="absolute inset-0 w-full border border-opacity-40 shadow-lg shadow-black/[0.03] backdrop-blur-[0.5rem] rounded-full bg-gray-950 border-black/40 bg-opacity-75"
      />
